...
const FrameShape: NextPage = () => {
  ...
  return (
    <div className="self-stretch flex flex-col items-center justify-start gap-[100px] max-w-full shrink-0 text-center text-sm text-iteck-gatsbyvercelapp-cornflower-blue font-iteck-gatsbyvercelapp-inter-regular-144 mq950:gap-[100px] mq1425:gap-[100px]">
      ...
      <div
        id="partners"
        className="w-full flex flex-col items-center justify-center pt-0 px-5 pb-px box-border min-h-[500px] gap-[41px] max-w-[1170px] mq950:gap-[41px] mq1425:max-w-full"
      >
        {/* in above div px-5 property can be changed to look the partner div more big */}
        <div className="flex flex-col items-center justify-start gap-[9px] max-w-full shrink-0">
          <div className="relative leading-[23.8px] inline-block max-w-[1140px] mq1425:max-w-full">{``}</div>
          <h1 className="m-15 relative text-58xl leading-[44.8px] font-bold font-inherit text-iteck-gatsbyvercelapp-shark inline-block max-w-[1140px] mq450:text-lgi mq450:leading-[27px] mq950:text-7xl mq950:leading-[36px] mq1425:max-w-full">
            Partners
          </h1>
        </div>
        {/* <form className="m-0 self-stretch flex flex-row flex-wrap items-start justify-center py-0 pr-[25px] pl-[15px] box-border max-w-full">
        ...
        <div className="flex flex-wrap items-center justify-center gap-10">
          ...
          />
          <Image
            src="/Webroot_by_OpenText_-_Logo_-_Normal.svg"
            alt="Partner 3"
            className="h-auto w-32"
            width={100}
            height={100}
          />
          <Image
            src="/black-primary-crowdstrike-logo.svg"
            alt="Partner 4"
            className="h-auto w-32"
            width={100}
            height={100}
          ...
          />
          <Image
            src="/cylance-vector-logo.svg"
            alt="Partner 7"
            className="h-auto w-32"
            width={100}
            height={100}
          />
          {/* cylance logo incomplete */}
            ...
            <div className="w-[1140px] rounded-xl bg-iteck-gatsbyvercelapp-cornflower-blue flex flex-col items-end justify-start pt-0 px-[50px] pb-[39px] box-border relative gap-[21px] max-w-full mq1425:pl-[25px] mq1425:pr-[25px] mq1425:box-border">
              ...
              <div className="w-[863px] flex flex-col items-start justify-start gap-[5px] max-w-full">
                <div className="self-stretch flex flex-row items-start justify-end max-w-full">
                  <div
                    className="ml-11 relative leading-[23.8px] inline-block max-w-[1140px] mq1425:max-w-full"
                    style={{ textAlign: "center" }}
                  >
                    {/* Teekay Syncs With The Apps You’re Already Using */}
                    Teekay empowers businesses of all sizes, from startups to
                    Fortune 500s. We deliver innovative solutions across
                    industries, helping clients achieve their goals.
                  </div>
                  <div className="mt-7 w-[687px] flex flex-row items-end justify-center py-1 pr-px pl-0 box-border gap-[20px] max-w-full mq950:flex-wrap">
