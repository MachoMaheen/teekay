...
const Section2: NextPage = () => {
  return (
    <section
      id="services"
      className="self-stretch h-[900px] overflow-hidden shrink-0 flex flex-col items-center justify-start py-0 px-[375px] box-border relative max-w-full text-left text-sm text-iteck-gatsbyvercelapp-cornflower-blue font-iteck-gatsbyvercelapp-inter-regular-144"
    >
          ...
          <div className="w-[1088px] flex flex-col items-start justify-start pt-[50px] px-0 pb-0 box-border max-w-full">
            <div className="self-stretch flex flex-row flex-wrap items-start justify-start py-0 pr-2.5 pl-0">
              <DivcolLg3
                ...
                firewallVPN={`Cybersecurity`}
                content="Protect your data and infrastructure from cyber threats with our comprehensive security solutions."
                png="/36png@2x.png"
              />
              <DivcolLg3
                service01="Service #02"
                firewallVPN="Enterprise Network Infrastructure"
                png="/37png@2x.png"
                content="Design, build, and manage secure and scalable networks for your business."
                propMarginLeft="-3.33px"
              />
              <DivcolLg3
                service01="Service #03"
                firewallVPN="Collaboration and Unified Communications"
                png="/38png@2x.png"
                content="Enhance communication and collaboration across your organization with our integrated solutions."
                propMarginLeft="-3.33px"
              />
              <DivcolLg3
                service01="Service #04"
                firewallVPN="Web applications and digital marketing solutions"
                png="/39png@2x.png"
                content="Develop engaging web applications and implement effective digital marketing strategies to reach your target audience."
                propMarginLeft="-3.33px"
              />
              {/* <DivcolLg2
            ...
            <div className="self-stretch flex flex-row flex-wrap items-center justify-center pt-02 pr-2.5 ">
              <DivcolLg3
                service01="Service #05"
                firewallVPN="Cloud and Productivity Solutions"
                png="/39png@2x.png"
                content="Leverage the power of the cloud to improve efficiency and productivity with our suite of tools and services."
                propMarginLeft="-3.33px"
              />
            </div>
          </div>
