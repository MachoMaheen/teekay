...
const DivcolLg3: NextPage<DivcolLg3Type> = ({
  ...
  const renderImage = () => {
    if (service01 === "Service #02") {
      return (
        <img
          className="w-[75px] h-[60px] absolute pt-10 mx-[!important] bottom-[-0.7px] left-[24px] overflow-hidden shrink-0 object-cover max-w-[224px] max-h-[60px]"
          loading="eager"
          alt=""
          src={png}
        />
      );
    } else if (service01 === "Service #01") {
      return (
        <img
          className="w-[75px] h-[60px] absolute pt-10 mx-[!important] bottom-[-0.7px] left-[24px] overflow-hidden shrink-0 object-cover max-w-[224px] max-h-[60px]"
          loading="eager"
  ...
  return (
    ...
    >
      <div className="flex-1 flex flex-col items-start justify-start pt-0 px-6 pb-[99px] relative gap-[10px]">
        ...
        <div className="my-6 h-12 relative leading-[23.8px] text-iteck-gatsbyvercelapp-dove-gray flex items-center max-w-[224px]">
          <span>
