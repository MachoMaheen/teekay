...
const Section: NextPage = () => {
  ...
  return (
    ...
    <section className="self-stretch  flex flex-row items-center justify-center p-[100px] box-border max-w-full shrink-0 text-left text-sm text-iteck-gatsbyvercelapp-cornflower-blue font-iteck-gatsbyvercelapp-inter-regular-144 mq950:py-[65px] mq950:px-[25px] mq950:box-border mq1425:pl-[50px] mq1425:pr-[50px] mq1425:box-border">
